...
exports.register = async (req, res) => {
  const { nombre_usuario, correo, clave, rol, fecha_nacimiento } = req.body;
  ...
  try {
    ...
    if (existingUser) {
      return res
        ...
        .json({
          message:
            "Oh no, parece que alguien ya tiene ese nombre. ¡Pero seguro tú puedes pensar en algo aún más brillante!",
        });
    }
